...
You should still be in the root folder (containing the ``requirements`` directory).

Your virtualenv should still be activated. If it isn't, activate it now. Install the new project's local development
requirements:
